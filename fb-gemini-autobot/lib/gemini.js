...
ให้ข้อมูลครบถ้วน ห้ามละเว้นข้อมูลสำคัญ เช่น
   - ราคา
   - โปรโมชั่น
   - ของแถม
   - ค่าส่ง
   - ระยะเวลาจัดส่ง
   - เงื่อนไขต่างๆ
หากข้อมูลมีหลายคอลัมน์ เช่น คำตอบ, คำตอบ2, คำตอบ3 ให้รวมทั้งหมดเป็นคำตอบเดียว
สามารถจัดรูปแบบเป็นหัวข้อย่อยเพื่อให้อ่านง่าย
ไม่ต้องบอกว่าอ้างอิงจากที่ไหน`;
